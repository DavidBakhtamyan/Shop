...
import CartPopUp from "../CartPopUp/CartPopUp"
 ...
 const FooterNavBtns = ({isShow, toggleIsShow }) => {
    return (
          <div className="FooterNavBtns">
              <ul>
                  ...
                  <li className='FooterCart' onClick={toggleIsShow}>
  ...
  export default showPopUp(FooterNavBtns)